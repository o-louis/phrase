    ...
    >
      <span class="flex items-center gap-3">
        ...
        <span class="flex flex-col">
          <span class="font-heading font-semibold">Review session</span>
          <span class="text-sm text-muted">{{ totalDue }} phrases due</span>
        </span>
      </span>
